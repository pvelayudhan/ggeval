  ...
  labs(title = "2D Density of Penguin Bill Length and Depth by Species", x = "Bill Length (mm)", y = "Bill Depth (mm)")
                    suppressWarnings(
                        ggsave(
                            width = 3,
                            height = 3,
                            "figures/bill-length_bill-depth_scatter_2d_density_submission_phi4mini.png"
                        )
                    )
                    suppressWarnings(
                        ggplot_build(last_plot())
