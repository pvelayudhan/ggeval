...
- *What does being good at ggplot2 even mean?*: I don't think it's possible to create a benchmarking set of questions that objectively captures exactly how good a person or LLM is at ggplot2. This benchmarking dataset arguably throws in some very unusual niche functionality from ggplot2 that a certified professional may have never needed. Maybe being good at ggplot2 means being able to make really long plots, or really aesthetic plots, or plots that use really obscure parameters. It's unfortunately a bit of a subjective thing. A key hope and assumption of the benchmarking dataset here is that it reasonably aligns with what any R user would perceive as ggplot2 ability.
